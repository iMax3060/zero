...
public:
    ...
    void add_fact(PageID pid, int16_t level, bool high, size_t prefix_len, const char* prefix, size_t suffix_len,
                  const char* suffix);
    ...
    /** for the case the string consists of two parts (prefix and suffix). */
    void add_expectation(PageID pid, int16_t level, bool high, size_t prefix_len, const char* prefix, size_t suffix_len,
                         const char* suffix);
