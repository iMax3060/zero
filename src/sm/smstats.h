...
public:
    ...
    void log_pick_victim_latched(tid_t tid, bf_idx b_idx, u_long start, u_long finish);
    void log_pick_victim_gclock(tid_t tid, bf_idx b_idx, bf_idx current_frame, u_long start, u_long finish);
