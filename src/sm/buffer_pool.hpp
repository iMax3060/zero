...
#ifndef __BUFFER_POOL_HPP
#define __BUFFER_POOL_HPP
...
namespace zero::buffer_pool {
    ...
    class PageEvictionerSFSkeleton;
...
namespace zero::buffer_pool {
	...
	class BufferPool {
        ...
        template <class selector_class, class filter_class, bool filter_early> friend class zero::buffer_pool::PageEvictionerSFSkeleton;
    ...
    public:
         ...
         *
         * \pre     \link smlevel_0::vol->_alloc_cache \endlink needs to be initialized before.
         ...
         *
         * @return  \c true if this buffer pool contains dirty buffer frames, \false else.
         */
        bool hasDirtyFrames();
         ...
         *                          \link SWIZZLED_PID_BIT \endlink set when swizzled).
         * @param[in]  latchMode    The wanted latch mode for the page that should be fixed (only
         *                          \link latch_mode_t::LATCH_SH \endlink and \link latch_mode_t::LATCH_EX \endlink
         *                          are allowed here).
         * @param[in]  conditional  Whether the fix is conditional (returns immediately even if failed).
         ...
         *             upgraded immediately \c true, else \false .
         */
         ...
         * @param numberOfPages The number of pages to prefetch (page ID of the last prefetched page: \startPID \c +
        ...
        /*!\fn      updateChildEMLSN(btree_page_h& parentPage, general_recordid_t childSlotID, lsn_t childEMLSN) const
    ...
    private:
         ...
         *          this buffer pool.
         */
        std::shared_ptr<zero::buffer_pool::PageEvictionerSFSkeleton<PageEvictionerSelectorLOOPPracticallyAccurate, PageEvictionerFilterNone, false>>
                                                                    _evictioner;
    ...
    bool fix_current() {
        ...
        try {
            smlevel_0::bf->_fix(nullptr, _current, _current_pid, LATCH_EX, conditional, _virgin, only_if_hit,
                                do_recovery);
        } catch (const zero::buffer_pool::BufferPool::BufferPoolOldStyleException& exception) {
            /*
