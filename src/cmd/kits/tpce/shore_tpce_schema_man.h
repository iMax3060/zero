...
#ifndef __okvl_mode::SORE_TPCE_SCHEMA_MANAGER_H
#define __okvl_mode::SORE_TPCE_SCHEMA_MANAGER_H

#include "shore_tpce_schema.h"
...
/* ----------------------------- */
    ...
    class account_permission_man_impl : public table_man_t<account_permission_t> {
    ...
    public:
        ...
        account_permission_man_impl(account_permission_t *aAccount_PermissionDesc)
                : table_man_t<account_permission_t>(aAccount_PermissionDesc) {}
        ...
        w_rc_t ap_get_iter_by_index(ss_m *db,
                                    ...
                                    rep_row_t &rephigh,
                                    const TIdent acct_id,
                                    lock_mode_t alm = okvl_mode::S,
                                    bool need_tuple = true);

        w_rc_t ap_update_acl(ss_m *db, account_permission_tuple *ptuple, const char *acl, lock_mode_t lm = okvl_mode::X);
    };
...
/* ----------------- */
    ...
    class broker_man_impl : public table_man_t<broker_t> {
...
/* ----------------------------- */
/* ---- CAokvl_mode::S_TRANSACTION ------- */
/* ----------------------------- */

    class cash_transaction_man_impl : public table_man_t<cash_transaction_t> {
        typedef table_row_t cash_transaction_tuple;

    public:

        cash_transaction_man_impl(cash_transaction_t *aCash_TransactionDesc)
                : table_man_t<cash_transaction_t>(aCash_TransactionDesc) {}
        ...
        w_rc_t ct_update_name(ss_m *db, cash_transaction_tuple *ptuple, const char *ct_name, lock_mode_t lm = okvl_mode::X);
    };
...
/* ----------------- */
    ...
    class charge_man_impl : public table_man_t<charge_t> {
    ...
    public:
        ...
        charge_man_impl(charge_t *aChargeDesc)
                : table_man_t<charge_t>(aChargeDesc) {}
...
/* ------------------------ */
    ...
    class commission_rate_man_impl : public table_man_t<commission_rate_t> {
    ...
    public:
        ...
        commission_rate_man_impl(commission_rate_t *aCommission_RateDesc)
                : table_man_t<commission_rate_t>(aCommission_RateDesc) {}
...
/* ----------------- */
    ...
    class company_man_impl : public table_man_t<company_t> {
    ...
    public:
        ...
        company_man_impl(company_t *aCompanyDesc)
                : table_man_t<company_t>(aCompanyDesc) {}

        ~company_man_impl() {}

        w_rc_t co_get_iter_by_index2(ss_m *db, company_index_iter *&iter, company_tuple *ptuple, rep_row_t &replow,
                                     rep_row_t &rephigh,
                                     const char *co_name, lock_mode_t alm = okvl_mode::S, bool need_tuple = false);
        ...
        w_rc_t co_update_sprate(ss_m *db, company_tuple *ptuple, const char *sprate, lock_mode_t lm = okvl_mode::X);

        w_rc_t co_get_iter_by_index3(ss_m *db, company_index_iter *&iter, company_tuple *ptuple, rep_row_t &replow,
                                     rep_row_t &rephigh,
                                     const char *in_id, lock_mode_t alm = okvl_mode::S, bool need_tuple = false);
...
/* ----------------- */
    ...
    public:
        ...
        w_rc_t c_update_email2(ss_m *db, customer_tuple *ptuple, const char *email2, lock_mode_t alm = okvl_mode::X);
...
/* ------------------------ */
    ...
    class customer_account_man_impl : public table_man_t<customer_account_t> {
    ...
    public:
        ...
        customer_account_man_impl(customer_account_t *aCustomer_AccountDesc)
                : table_man_t<customer_account_t>(aCustomer_AccountDesc) {}
...
/* ------------------------ */
    ...
    class customer_taxrate_man_impl : public table_man_t<customer_taxrate_t> {
    ...
    public:
        ...
        customer_taxrate_man_impl(customer_taxrate_t *aCustomer_TaxrateDesc)
                : table_man_t<customer_taxrate_t>(aCustomer_TaxrateDesc) {}
        ...
        w_rc_t cx_update_txid(ss_m *db, customer_taxrate_tuple *ptuple, const char *new_tax_rate, lock_mode_t lm = okvl_mode::X);
...
/* ---------------- */
    ...
    class holding_man_impl : public table_man_t<holding_t> {
    ...
    public:
        ...
        holding_man_impl(holding_t *aHoldingDesc)
                : table_man_t<holding_t>(aHoldingDesc) {}
        ...
        w_rc_t h_update_qty(ss_m *db, holding_tuple *ptuple, const int qty, lock_mode_t lm = okvl_mode::X);

        w_rc_t h_delete_tuple(ss_m *db, holding_tuple *ptuple);
...
/* ------------------------ */
    ...
    class holding_history_man_impl : public table_man_t<holding_history_t> {
    ...
    public:
        ...
        holding_history_man_impl(holding_history_t *aHolding_HistoryDesc)
                : table_man_t<holding_history_t>(aHolding_HistoryDesc) {}
...
/* ------------------------ */
    ...
    class holding_summary_man_impl : public table_man_t<holding_summary_t> {
    ...
    public:
        ...
        holding_summary_man_impl(holding_summary_t *aHolding_SummaryDesc)
                : table_man_t<holding_summary_t>(aHolding_SummaryDesc) {}
...
/* --------------------- */
    ...
    class last_trade_man_impl : public table_man_t<last_trade_t> {
        typedef table_row_t last_trade_tuple;

    public:

        last_trade_man_impl(last_trade_t *aLast_TradeDesc)
                : table_man_t<last_trade_t>(aLast_TradeDesc) {}
...
/* ----------------- */
    ...
    class security_man_impl : public table_man_t<security_t> {
    ...
    public:
        ...
        security_man_impl(security_t *aSecurityDesc)
                : table_man_t<security_t>(aSecurityDesc) {}
        ...
        w_rc_t s_update_ed(ss_m *db, security_tuple *ptuple, const myTime exch_date, lock_mode_t lm = okvl_mode::X);
...
/* ------------------- */
    ...
    class settlement_man_impl : public table_man_t<settlement_t> {
        typedef table_row_t settlement_tuple;

    public:

        settlement_man_impl(settlement_t *aSettlementDesc)
                : table_man_t<settlement_t>(aSettlementDesc) {}
        ...
        w_rc_t se_update_name(ss_m *db, settlement_tuple *ptuple, const char *cash_type, lock_mode_t lm = okvl_mode::X);
...
/* -------------------- */
    ...
    class taxrate_man_impl : public table_man_t<taxrate_t> {
        typedef table_row_t taxrate_tuple;

    public:

        taxrate_man_impl(taxrate_t *aTaxrateDesc)
                : table_man_t<taxrate_t>(aTaxrateDesc) {}
        ...
        w_rc_t tx_update_name(ss_m *db, taxrate_tuple *ptuple, const char *tx_name, lock_mode_t lm = okvl_mode::X);
...
/* --------------- */
    ...
    public:
        ...
        w_rc_t t_update_tax_by_index(ss_m *db, trade_tuple *ptuple, const TIdent t_id,
                                     const double tax_amount, lock_mode_t lm = okvl_mode::X);
        ...
        w_rc_t t_update_name(ss_m *db, trade_tuple *ptuple, const char *exec_name, lock_mode_t lm = okvl_mode::X);
...
/* ----------------------- */
    ...
    class trade_history_man_impl : public table_man_t<trade_history_t> {
    ...
    public:
        ...
        trade_history_man_impl(trade_history_t *aTrade_HistoryDesc)
                : table_man_t<trade_history_t>(aTrade_HistoryDesc) {}
...
/* -------------------- */
    ...
    class trade_type_man_impl : public table_man_t<trade_type_t> {
        typedef table_row_t trade_type_tuple;

    public:

        trade_type_man_impl(trade_type_t *aTrade_TypeDesc)
                : table_man_t<trade_type_t>(aTrade_TypeDesc) {}
...
/* ------------------- */
    ...
    class status_type_man_impl : public table_man_t<status_type_t> {
        typedef table_row_t status_type_tuple;

    public:

        status_type_man_impl(status_type_t *aStatus_TypeDesc)
                : table_man_t<status_type_t>(aStatus_TypeDesc) {}
...
/* ------------------- */
    ...
    class sector_man_impl : public table_man_t<sector_t> {
    ...
    public:
        ...
        sector_man_impl(sector_t *aSectorDesc)
                : table_man_t<sector_t>(aSectorDesc) {}
...
/* ------------------- */
    ...
    class exchange_man_impl : public table_man_t<exchange_t> {
    ...
    public:
        ...
        exchange_man_impl(exchange_t *aExchangeDesc)
                : table_man_t<exchange_t>(aExchangeDesc) {}

        ~exchange_man_impl() {}

        w_rc_t ex_update_desc(ss_m *db, exchange_tuple *ptuple, const char *new_desc, lock_mode_t alm = okvl_mode::X);
...
/* ------------------- */
    ...
    class industry_man_impl : public table_man_t<industry_t> {
    ...
    public:
        ...
        industry_man_impl(industry_t *aIndustryDesc)
                : table_man_t<industry_t>(aIndustryDesc) {}
...
/* ------------------- */
    ...
    class zip_code_man_impl : public table_man_t<zip_code_t> {
    ...
    public:
        ...
        zip_code_man_impl(zip_code_t *aZip_CodeDesc)
                : table_man_t<zip_code_t>(aZip_CodeDesc) {}
...
/* ------------------- */
    ...
    class trade_request_man_impl : public table_man_t<trade_request_t> {
    ...
    public:
        ...
        trade_request_man_impl(trade_request_t *aTrade_RequestDesc)
                : table_man_t<trade_request_t>(aTrade_RequestDesc) {}

        ~trade_request_man_impl() {}

        w_rc_t tr_delete_tuple(ss_m *db, trade_request_tuple *ptuple);
...
/* --------------------------*/
    ...
    class company_competitor_man_impl : public table_man_t<company_competitor_t> {
    ...
    public:
        ...
        company_competitor_man_impl(company_competitor_t *aCompany_CompetitorDesc)
                : table_man_t<company_competitor_t>(aCompany_CompetitorDesc) {}
...
/* --------------------------*/
    ...
    class daily_market_man_impl : public table_man_t<daily_market_t> {
    ...
    public:
        ...
        daily_market_man_impl(daily_market_t *aDaily_MarketDesc)
                : table_man_t<daily_market_t>(aDaily_MarketDesc) {}

        ~daily_market_man_impl() {}

        w_rc_t dm_index_probe(ss_m *db, daily_market_tuple *ptuple, const char *symbol, const myTime start_date);

        w_rc_t dm_update_vol(ss_m *db, daily_market_tuple *ptuple, const int vol_incr, lock_mode_t lm = okvl_mode::X);
...
/* -----------------------*/
    ...
    class financial_man_impl : public table_man_t<financial_t> {
    ...
    public:
        ...
        financial_man_impl(financial_t *aFinancialDesc)
                : table_man_t<financial_t>(aFinancialDesc) {}

        ~financial_man_impl() {}

        w_rc_t fi_update_desc(ss_m *db, financial_tuple *ptuple, const myTime new_qtr_start_date, lock_mode_t alm = okvl_mode::X);
...
/* -----------------------*/
    ...
    class address_man_impl : public table_man_t<address_t> {
        typedef table_row_t address_tuple;

    public:

        address_man_impl(address_t *aAddressDesc)
                : table_man_t<address_t>(aAddressDesc) {}
        ...
        w_rc_t ad_update_line2(ss_m *db, address_tuple *ptuple, const char *line2, lock_mode_t = okvl_mode::X);
...
/* -----------------------*/
    ...
    class watch_item_man_impl : public table_man_t<watch_item_t> {
    ...
    public:
        ...
        watch_item_man_impl(watch_item_t *aWatch_ItemDesc)
                : table_man_t<watch_item_t>(aWatch_ItemDesc) {}

        ~watch_item_man_impl() {}

        w_rc_t wi_update_symb(ss_m *db, watch_item_tuple *ptuple, const TIdent wl_id,
                              const char *old_symbol, const char *new_symbol, lock_mode_t lm = okvl_mode::X);
...
/* -----------------------*/
    ...
    class watch_list_man_impl : public table_man_t<watch_list_t> {
    ...
    public:
        ...
        watch_list_man_impl(watch_list_t *aWatch_ListDesc)
                : table_man_t<watch_list_t>(aWatch_ListDesc) {}
...
/* -----------------------*/
    ...
    class news_item_man_impl : public table_man_t<news_item_t> {
        typedef table_row_t news_item_tuple;

    public:

        news_item_man_impl(news_item_t *aNews_ItemDesc)
                : table_man_t<news_item_t>(aNews_ItemDesc) {}
        ...
        w_rc_t ni_update_dts_by_index(ss_m *db, news_item_tuple *ptuple, const myTime ni_dts, lock_mode_t alm = okvl_mode::X);
...
/* -----------------------*/
    ...
    class news_xref_man_impl : public table_man_t<news_xref_t> {
    ...
    public:
        ...
        news_xref_man_impl(news_xref_t *aNews_XrefDesc)
                : table_man_t<news_xref_t>(aNews_XrefDesc) {}
...
#endif /* __okvl_mode::SORE_TPCE_SCHEMA_MANAGER_H */
