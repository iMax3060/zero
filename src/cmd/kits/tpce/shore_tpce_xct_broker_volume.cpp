    ...
    w_rc_t ShoreTPCEEnv::xct_broker_volume(const int xct_id,
        ...
        */
        ...
        guard<index_scan_iter_impl < sector_t> > sc_iter;
        {
            ...
            W_DO(_psector_man->sc_get_iter_by_index2(tmp_sc_iter, prsector,
                                                     lowrep, highrep,
                                                     pbvin._sector_name));
            sc_iter = tmp_sc_iter;
        }
        ...
        W_DO(sc_iter->next(eof, *prsector));
        ...
        for (uint i = 0;
            ...
            guard<index_scan_iter_impl < broker_t> > br_iter;
            {
                ...
                W_DO(_pbroker_man->b_get_iter_by_index3(tmp_br_iter, prbroker,
                                                        lowrep, highrep,
                                                        pbvin._broker_list[i]));
                br_iter = tmp_br_iter;
            }
            TRACE(TRACE_TRX_FLOW, "App: %d BV:br-iter-next \n", xct_id);
            W_DO(br_iter->next(eof, *prbroker));
            ...
            guard<index_scan_iter_impl < industry_t> > in_iter;
            {
                ...
                TRACE(TRACE_TRX_FLOW, "App: %d BV:in-get-iter-by-idx3 (%s) \n",
                      xct_id, sc_id);
                W_DO(_pindustry_man->in_get_iter_by_index3(tmp_in_iter,
                                                           prindustry,
            ...
            W_DO(in_iter->next(eof, *prindustry));
            ...
            while (!eof) {
                ...
                guard<index_scan_iter_impl < company_t> > co_iter;
                {
                    ...
                    TRACE(TRACE_TRX_FLOW, "App: %d BV:co-get-iter-by-idx3 (%s) \n",
                          xct_id, in_id);
                    W_DO(_pcompany_man->co_get_iter_by_index3(tmp_co_iter,
                                                              prcompany, lowrep,
                                                              highrep, in_id));
                    co_iter = tmp_co_iter;
                }
                ...
                W_DO(co_iter->next(eof, *prcompany));
                ...
                while (!eof) {
                    ...
                    guard<index_scan_iter_impl < security_t> > s_iter;
                    {
                        ...
                        TRACE(TRACE_TRX_FLOW,
                              ...
                              xct_id, co_id);
                        W_DO(_psecurity_man->s_get_iter_by_index4(tmp_s_iter,
                                                                  prsecurity, lowrep,
                                                                  highrep, co_id));
                        s_iter = tmp_s_iter;
                    }
                    ...
                    W_DO(s_iter->next(eof, *prsecurity));
                    ...
                    while (!eof) {
                        ...
                        guard<index_scan_iter_impl < trade_request_t> > tr_iter;
                        {
                            ...
                            W_DO(_ptrade_request_man->
                                    tr_get_iter_by_index4(tmp_tr_iter, prtradereq,
                                                          lowrep, highrep,
                                                          s_symb, b_id));
                            tr_iter = tmp_tr_iter;
                        }
                        ...
                        W_DO(tr_iter->next(eof, *prtradereq));
        ...
        if (list_len > 0) {
            ...
            desc_sort_iter_impl tr_list_sort_iter(&tr_list, &tr_sorter);
            bool eof;
            W_DO(tr_list_sort_iter.next(eof, rsb));
