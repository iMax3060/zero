...
#include "shore_tpce_schema_man.h"
...
/* ----------------------------- */
    ...
    w_rc_t account_permission_man_impl::ap_index_probe(ss_m *db, account_permission_tuple *ptuple,
        ...
        return (index_probe_by_name(db, "AP_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t account_permission_man_impl::ap_get_iter_by_index(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("AP_INDokvl_mode::X");
        assert (pindex);

        // AP_INDokvl_mode::X: { 0, 2 }
...
/* ----------------- */
    ...
    w_rc_t address_man_impl::ad_index_probe(ss_m *db, address_tuple *ptuple, const TIdent ad_id) {
        ...
        return (index_probe_by_name(db, "AD_INDokvl_mode::X", ptuple));
    }

    w_rc_t address_man_impl::ad_index_probe_forupdate(ss_m *db, address_tuple *ptuple, const TIdent ad_id) {
        assert (ptuple);
        ptuple->set_value(0, ad_id);
        return (index_probe_forupdate_by_name(db, "AD_INDokvl_mode::X", ptuple));
    }
...
/* ----------------- */
    ...
    w_rc_t broker_man_impl::broker_update_ca_nt_by_index(ss_m *db, broker_tuple *ptuple, const TIdent broker_id,
        ...
        W_DO(index_probe_forupdate_by_name(db, "B_INDokvl_mode::X", ptuple));
    ...
    w_rc_t broker_man_impl::b_get_iter_by_index2(ss_m *db,
        ...
        index_desc_t *pindex = _ptable->find_index("B_INDokvl_mode::X_2");
        assert (pindex);

        // B_INDokvl_mode::X: { 0, 2 }
    ...
    w_rc_t broker_man_impl::b_get_iter_by_index3(ss_m *db,
        ...
        index_desc_t *pindex = _ptable->find_index("B_INDokvl_mode::X_3");
        assert (pindex);

        // CR_INDokvl_mode::X: { 2, 0 }
...
/* ----------------------------- */
    ...
    w_rc_t cash_transaction_man_impl::ct_index_probe(ss_m *db, cash_transaction_tuple *ptuple, const TIdent tr_id) {
        ...
        return (index_probe_by_name(db, "CT_INDokvl_mode::X", ptuple));
    }

    w_rc_t
    cash_transaction_man_impl::ct_index_probe_forupdate(ss_m *db, cash_transaction_tuple *ptuple, const TIdent t_id) {
        assert (ptuple);
        ptuple->set_value(0, t_id);
        return (index_probe_forupdate_by_name(db, "CT_INDokvl_mode::X", ptuple));
    }

    w_rc_t cash_transaction_man_impl::ct_update_name(ss_m *db, cash_transaction_tuple *ptuple, const char *ct_name,
                                                     lock_mode_t lm) {
        assert (ptuple);
...
/* ----------------- */
    ...
    w_rc_t
    charge_man_impl::ch_index_probe(ss_m *db, charge_tuple *ptuple, const short cust_tier, const char *trade_type_id) {
        assert (ptuple);
        ptuple->set_value(0, trade_type_id);
        ptuple->set_value(1, cust_tier);
        return (index_probe_by_name(db, "CH_INDokvl_mode::X", ptuple));
    }
...
/* ------------------------ */
    ...
    w_rc_t commission_rate_man_impl::cr_get_iter_by_index(ss_m *db,
        ...
        index_desc_t *pindex = _ptable->find_index("CR_INDokvl_mode::X");
        assert (pindex);

        // CR_INDokvl_mode::X: { 0, 1, 2, 3 }
...
/* ----------------- */
    ...
    w_rc_t company_man_impl::co_get_iter_by_index2(ss_m *db,
        ...
        //find index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("CO_INDokvl_mode::X_2");
        assert (pindex);
    ...
    w_rc_t company_man_impl::co_index_probe(ss_m *db, company_tuple *ptuple, const TIdent co_id) {
        ...
        return (index_probe_by_name(db, "CO_INDokvl_mode::X", ptuple));
    }

    w_rc_t company_man_impl::co_index_probe_forupdate(ss_m *db, company_tuple *ptuple, const TIdent co_id) {
        assert (ptuple);
        ptuple->set_value(0, co_id);
        return (index_probe_forupdate_by_name(db, "CO_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t company_man_impl::co_get_iter_by_index3(ss_m *db,
        ...
        /* find index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("CO_INDokvl_mode::X_3");
        assert (pindex);
...
/* --------------------------- */
    ...
    w_rc_t company_competitor_man_impl::cc_get_iter_by_index(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("CP_INDokvl_mode::X");
        assert (pindex);

        // CP_INDokvl_mode::X: { 0, 1, 2 }
...
/* ----------------- */
    ...
    w_rc_t customer_man_impl::c_index_probe(ss_m *db, customer_tuple *ptuple, const TIdent cust_id) {
        ...
        return (index_probe_by_name(db, "C_INDokvl_mode::X", ptuple));
    }

    w_rc_t customer_man_impl::c_index_probe_forupdate(ss_m *db, customer_tuple *ptuple, const TIdent cust_id) {
        assert (ptuple);
        ptuple->set_value(0, cust_id);
        return (index_probe_forupdate_by_name(db, "C_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t customer_man_impl::c_get_iter_by_index2(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("C_INDokvl_mode::X_2");
        assert (pindex);

        // C_INDokvl_mode::X_2: { 1 , 0 }
    ...
    w_rc_t customer_man_impl::c_get_iter_by_index3(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("C_INDokvl_mode::X_3");
        assert (pindex);

        // C_INDokvl_mode::X_2: { 0 , 7 }
...
/* ------------------------ */
    ...
    w_rc_t customer_account_man_impl::ca_index_probe(ss_m *db, customer_account_tuple *ptuple, const TIdent acct_id) {
        assert (ptuple);
        ptuple->set_value(0, acct_id);
        return (index_probe_by_name(db, "CA_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t customer_account_man_impl::ca_update_bal(ss_m *db, customer_account_tuple *ptuple,
        ...
        ptuple->set_value(0, acct_id);
        W_DO(index_probe_forupdate_by_name(db, "CA_INDokvl_mode::X", ptuple));
    ...
    w_rc_t customer_account_man_impl::ca_get_iter_by_index2(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("CA_INDokvl_mode::X_2");
        assert (pindex);

        // CA_INDokvl_mode::X_2: { 2 }
...
/* ------------------------ */
    ...
    w_rc_t customer_taxrate_man_impl::cx_get_iter_by_index(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("CX_INDokvl_mode::X");
        assert (pindex);

        // CX_INDokvl_mode::X: { 1 , 0 }
    ...
    w_rc_t customer_taxrate_man_impl::cx_update_txid(ss_m *db,
        ...
        W_DO(delete_index_entry(db, "CX_INDokvl_mode::X", ptuple));
        ...
        W_DO(add_index_entry(db, "CX_INDokvl_mode::X", ptuple));
...
/* ---------------------- */
    ...
    w_rc_t daily_market_man_impl::dm_index_probe(ss_m *db, daily_market_tuple *ptuple,
        ...
        return (index_probe_by_name(db, "DM_INDokvl_mode::X_2", ptuple));
    }
    ...
    w_rc_t daily_market_man_impl::dm_get_iter_by_index(ss_m *db,
        ...
        //DM_INDokvl_mode::X { 1, 0 }

        /* find the index */

        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("DM_INDokvl_mode::X");
        assert (pindex);
...
/* ---------------------- */
    ...
    w_rc_t exchange_man_impl::ex_index_probe(ss_m *db,
        ...
        return (index_probe_by_name(db, "okvl_mode::X_INDokvl_mode::X", ptuple));
    }
...
/* ---------------------- */
    ...
    w_rc_t financial_man_impl::fi_get_iter_by_index(ss_m *db,
        ...
        //FI_INDokvl_mode::X { 0, 1, 2 }

        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("FI_INDokvl_mode::X");
        assert (pindex);
...
/* ---------------- */
    ...
    w_rc_t holding_man_impl::h_get_iter_by_index2(ss_m *db,
        ...
        //H_INDokvl_mode::X_2 { 1, 2, 3 }

        /* find the index */

        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("H_INDokvl_mode::X_2");
        assert (pindex);
    ...
    w_rc_t holding_man_impl::h_delete_tuple(ss_m *db, holding_tuple *ptuple, rid_t rid) {
        ...
        // 1. read tuple
        ptuple->set_rid(rid);
        W_DO(read_tuple(ptuple, okvl_mode::X));
...
/* ------------------------ */
    ...
    w_rc_t holding_history_man_impl::hh_get_iter_by_index2(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("HH_INDokvl_mode::X_2");
        assert (pindex);

        // HH_INDokvl_mode::X_2: { 1 }
...
/* ------------------------ */
    ...
    w_rc_t holding_summary_man_impl::hs_index_probe(ss_m *db,
        ...
        ptuple->set_value(0, acct_id);
        ptuple->set_value(1, symbol);
        return (index_probe_by_name(db, "HS_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t holding_summary_man_impl::hs_update_qty(ss_m *db,
        ...
        ptuple->set_value(0, acct_id);
        ptuple->set_value(1, symbol);
        W_DO(index_probe_forupdate_by_name(db, "HS_INDokvl_mode::X", ptuple));
    ...
    w_rc_t holding_summary_man_impl::hs_get_iter_by_index(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("HS_INDokvl_mode::X");
        assert (pindex);

        // HS_INDokvl_mode::X: { 0, 1 }
...
/* -------------------- */
    ...
    w_rc_t industry_man_impl::in_index_probe(ss_m *db, industry_tuple *ptuple, const char *id) {
        assert (ptuple);
        ptuple->set_value(0, id);
        return (index_probe_by_name(db, "IN_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t industry_man_impl::in_get_iter_by_index2(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("IN_INDokvl_mode::X_2");
        assert (pindex);
    ...
    w_rc_t industry_man_impl::in_get_iter_by_index3(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("IN_INDokvl_mode::X_3");
        assert (pindex);
...
/* --------------------- */
    ...
    w_rc_t last_trade_man_impl::lt_index_probe(ss_m *db, last_trade_tuple *ptuple, const char *symbol) {
        ...
        return (index_probe_by_name(db, "LT_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t last_trade_man_impl::lt_update_by_index(ss_m *db, last_trade_tuple *ptuple,
        ...
        ptuple->set_value(0, symbol);
        W_DO(index_probe_forupdate_by_name(db, "LT_INDokvl_mode::X", ptuple));
...
/* ----------------- */
    ...
    w_rc_t security_man_impl::s_index_probe(ss_m *db, security_tuple *ptuple, const char *symbol) {
        assert (ptuple);
        ptuple->set_value(0, symbol);
        return (index_probe_by_name(db, "S_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t security_man_impl::s_get_iter_by_index4(ss_m *db,
        ...
        index_desc_t *pindex = _ptable->find_index("S_INDokvl_mode::X_4");
        assert (pindex);

        // S_INDokvl_mode::X_4: { 5, 1, 0 }
    ...
    w_rc_t security_man_impl::s_get_iter_by_index(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("S_INDokvl_mode::X");
        assert (pindex);
    ...
    w_rc_t security_man_impl::s_index_probe_forupdate(ss_m *db,
        ...
        assert (ptuple);
        ptuple->set_value(0, symbol);
        return (index_probe_forupdate_by_name(db, "S_INDokvl_mode::X", ptuple));
    }
...
/* ------------------- */
    ...
    w_rc_t news_item_man_impl::ni_index_probe(ss_m *db, news_item_tuple *ptuple, const TIdent ni_id) {
        ...
        return (index_probe_by_name(db, "NI_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t news_item_man_impl::ni_index_probe_forupdate(ss_m *db,
        ...
        assert (ptuple);
        ptuple->set_value(0, ni_id);
        return (index_probe_forupdate_by_name(db, "NI_INDokvl_mode::X", ptuple));
    }
...
/* ------------------- */
    ...
    w_rc_t news_xref_man_impl::nx_get_iter_by_index(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("NX_INDokvl_mode::X");
        assert (pindex);
...
/* ------------------- */
    ...
    w_rc_t status_type_man_impl::st_index_probe(ss_m *db, status_type_tuple *ptuple, const char *st_id) {
        ...
        return (index_probe_by_name(db, "ST_INDokvl_mode::X", ptuple));
    }
...
/* --------------- */
    ...
    w_rc_t sector_man_impl::sc_get_iter_by_index2(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("SC_INDokvl_mode::X_2");
        assert (pindex);
...
/* ------------------- */
    ...
    w_rc_t settlement_man_impl::se_index_probe(ss_m *db, settlement_tuple *ptuple, const TIdent tr_id) {
        assert (ptuple);
        ptuple->set_value(0, tr_id);
        return (index_probe_by_name(db, "SE_INDokvl_mode::X", ptuple));
    }

    w_rc_t settlement_man_impl::se_index_probe_forupdate(ss_m *db, settlement_tuple *ptuple, const TIdent tr_id) {
        assert (ptuple);
        ptuple->set_value(0, tr_id);
        return (index_probe_forupdate_by_name(db, "SE_INDokvl_mode::X", ptuple));
    }

    w_rc_t
    settlement_man_impl::se_update_name(ss_m *db, settlement_tuple *ptuple, const char *cash_type, lock_mode_t lm) {
        assert (ptuple);
...
/* -------------------- */
    ...
    w_rc_t taxrate_man_impl::tx_index_probe(ss_m *db, taxrate_tuple *ptuple, const char *tx_id) {
        ...
        return (index_probe_by_name(db, "TX_INDokvl_mode::X", ptuple));
    }

    w_rc_t taxrate_man_impl::tx_index_probe_forupdate(ss_m *db, taxrate_tuple *ptuple, const char *tx_id) {
        assert (ptuple);
        ptuple->set_value(0, tx_id);
        return (index_probe_forupdate_by_name(db, "TX_INDokvl_mode::X", ptuple));
    }
...
/* --------------- */
    ...
    w_rc_t trade_man_impl::t_index_probe(ss_m *db, trade_tuple *ptuple, const TIdent trade_id) {
        ...
        return (index_probe_by_name(db, "T_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t trade_man_impl::t_update_tax_by_index(ss_m *db,
        ...
        ptuple->set_value(0, t_id);
        W_DO(index_probe_forupdate_by_name(db, "T_INDokvl_mode::X", ptuple));
    ...
    w_rc_t trade_man_impl::t_update_dts_stdid_by_index(ss_m *db,
        ...
        W_DO(delete_index_entry(db, "T_INDokvl_mode::X_2", ptuple));
        W_DO(delete_index_entry(db, "T_INDokvl_mode::X_3", ptuple));
        ...
        W_DO(add_index_entry(db, "T_INDokvl_mode::X_2", ptuple));
        W_DO(add_index_entry(db, "T_INDokvl_mode::X_3", ptuple));
    ...
    w_rc_t trade_man_impl::t_get_iter_by_index2(ss_m *db,
        ...
        // T_INDokvl_mode::X_2 { 8, 1, 0 }

        /* pointer to the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("T_INDokvl_mode::X_2");
        assert (pindex);
    ...
    w_rc_t trade_man_impl::t_get_iter_by_index3(ss_m *db,
        ...
        // T_INDokvl_mode::X_3 { 5, 1 }

        // pointer to the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("T_INDokvl_mode::X_3");
        assert (pindex);
    ...
    w_rc_t trade_man_impl::t_index_probe_forupdate(ss_m *db, trade_tuple *ptuple, const TIdent t_id) {
        assert (ptuple);
        ptuple->set_value(0, t_id);
        return (index_probe_forupdate_by_name(db, "T_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t trade_man_impl::t_get_iter_by_index(ss_m *db,
        ...
        /* pointer to the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("T_INDokvl_mode::X");
        assert (pindex);
...
/* ----------------------- */
    ...
    w_rc_t trade_history_man_impl::th_get_iter_by_index(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("TH_INDokvl_mode::X_3");
        assert (pindex);
...
/* ----------------------- */
    ...
    w_rc_t trade_request_man_impl::tr_get_iter_by_index4(ss_m *db,
        ...
        // find the index
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("TR_INDokvl_mode::X_4");
        assert (pindex);

        // TR_INDokvl_mode::X_2: { 2, 5 }
...
/* -------------------- */
    ...
    w_rc_t trade_type_man_impl::tt_index_probe(ss_m *db,
        ...
        assert (ptuple);
        ptuple->set_value(0, trade_type_id);
        return (index_probe_by_name(db, "TT_INDokvl_mode::X", ptuple));
    }
...
/* -------------------- */
    ...
    w_rc_t watch_item_man_impl::wi_update_symb(ss_m *db, watch_item_tuple *ptuple, const TIdent wl_id,
        ...
        W_DO(index_probe_forupdate_by_name(db, "WI_INDokvl_mode::X", ptuple));

        // 2. delete the old entry from the index
        W_DO(delete_index_entry(db, "WI_INDokvl_mode::X", ptuple));
        ...
        // 4. add the updated entry to the index
        W_DO(add_index_entry(db, "WI_INDokvl_mode::X", ptuple));
    }
    ...
    w_rc_t watch_item_man_impl::wi_get_iter_by_index(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("WI_INDokvl_mode::X");
        assert (pindex);
...
/* -------------------- */
    ...
    w_rc_t watch_list_man_impl::wl_get_iter_by_index2(ss_m *db,
        ...
        /* find the index */
        assert (_ptable);
        index_desc_t *pindex = _ptable->find_index("WL_INDokvl_mode::X_2");
        assert (pindex);
...
/* -------------------- */
    ...
    w_rc_t zip_code_man_impl::zc_index_probe(ss_m *db,
        ...
        return (index_probe_by_name(db, "ZC_INDokvl_mode::X", ptuple));
    }
