...
namespace tpce {
    ...
    char EMAIL_DOMAINs[iNumEMAIL_DOMAINs][15] = {"@msn.com", "@hotmail.com", "@rr.com", "@netzero.com",
...
CCustomerTable::CCustomerTable(CInputFiles inputFiles,
        ...
        : TableTemplate<CUSTOMER_ROW>(), m_iRowsToGenerate(iCustomerCount),
          m_person(inputFiles, iStartFromCustomer, true), m_Phones(inputFiles.AreaCodes),
          m_StatusTypeFile(inputFiles.StatusType), m_iStartFromCustomer(iStartFromCustomer),
