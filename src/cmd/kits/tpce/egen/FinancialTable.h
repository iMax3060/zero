...
//
    ...
    class CFinancialTable : public TableTemplate<FINANCIAL_GEN_ROW> {
        ...
        bool GenerateFinancialRows() {
            ...
            for (i = 0; i < iFinsPerCompany; ++i) {
                ...
                iOutBasic = (INT64) ((double) iOutBasic *
                                     m_rnd.RndDoubleIncrRange(fFinDataDownMult, fFinDataUpMult, fFinDataIncr));
    ...
    public:
        CFinancialTable(CInputFiles inputFiles,
                ...
                : TableTemplate<FINANCIAL_GEN_ROW>(), m_CompanyTable(inputFiles, iCustomerCount, iStartFromCustomer),
            ...
            m_iFinancialCountForOneLoadUnit =
                    inputFiles.Company->CalculateCompanyCount(iDefaultLoadUnitSize) * iFinsPerCompany;
