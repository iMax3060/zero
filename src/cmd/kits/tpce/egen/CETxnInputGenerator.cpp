...
CCETxnInputGenerator::CCETxnInputGenerator(const CInputFiles &inputFiles,
        ...
        , m_Person(inputFiles, 0, false), m_CustomerSelection(&m_rnd, iDefaultStartFromCustomer, iActiveCustomerCount),
          ...
          m_Brokers(inputFiles, iActiveCustomerCount, iDefaultStartFromCustomer), m_pCompanies(inputFiles.Company),
          m_pSecurities(inputFiles.Securities), m_pIndustries(inputFiles.Industry), m_pSectors(inputFiles.Sectors),
...
CCETxnInputGenerator::CCETxnInputGenerator(const CInputFiles &inputFiles,
        ...
        , m_Person(inputFiles, 0, false),
          m_CustomerSelection(&m_rnd, iDefaultStartFromCustomer, iActiveCustomerCount, iPartitionPercent,
...
void CCETxnInputGenerator::Initialize() {
    ...
    m_iMaxActivePrePopulatedTradeID =
            (INT64) (((INT64) m_iHoursOfInitialTrades * SecondsPerHour * (m_iActiveCustomerCount / m_iScaleFactor)) *
                     iAbortTrade / INT64_CONST(100));  // 1.01 to account for rollbacks
...
*/
inline void
CCETxnInputGenerator::GenerateNonUniformRandomCustomerId(TIdent &iCustomerId, eCustomerTier &iCustomerTier) {
...
*/
void
CCETxnInputGenerator::GenerateNonUniformTradeDTS(tpce::TIMESTAMP_STRUCT &dts, INT64 MaxTimeInMilliSeconds, INT32 AValue,
                                                 INT32 SValue) {
