...
namespace tpce {
    ...
    public:
        CNewsItemAndXRefTable(CInputFiles inputFiles,
                ...
                : m_CompanyTable(inputFiles, iCustomerCount, iStartFromCustomer), m_pNews(inputFiles.News),
                  m_pLastNames(inputFiles.LastNames), m_iNewsItemsGeneratedForCompany(0) {
            ...
            m_iNewsCountForOneLoadUnit =
                    inputFiles.Company->CalculateCompanyCount(iDefaultLoadUnitSize) * iNewsItemsPerCompany;
        };
