        ...
        */
        CCustomerAccountsAndPermissionsTable(CInputFiles inputFiles,
                ...
                : TableTemplate<CUSTOMER_ACCOUNT_AND_PERMISSION_ROW>(),
                  ...
                  m_pNonTaxableAccountName(inputFiles.NonTaxableAccountName), m_iStartFromCustomer(iStartFromCustomer),
                  ...
                  m_person(inputFiles, iStartFromCustomer, bCacheEnabled), m_iPermsForCA(0),
                  m_iBrokersCount(iLoadUnitSize / iBrokersDiv),
                  m_addr(inputFiles, iCustomerCount, iStartFromCustomer, bCacheEnabled), m_iLoadUnitSize(iLoadUnitSize),
        ...
        */
        TIdent GenerateNextCA_AD() {
            ...
            if (m_iRowsGeneratedForCust ==
                m_iRowsToGenForCust) {   //select next customer id as all the rows for this customer have been generated
        ...
        */
        TIdent GenerateBrokerIdForAccount(TIdent iCA_ID) {
            ...
            TIdent iStartFromBroker =
                    (iCustomerId / m_iLoadUnitSize) * m_iBrokersCount + iStartingBrokerID + iTIdentShift;
