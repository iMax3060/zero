    ...
    public:
        ...
        CHoldingsAndTradesTable(CInputFiles inputFiles,
            ...
            if (m_bCacheEnabled) {
                ...
                m_iCacheOffsetNS = m_CustomerAccountTable.GetStartingCA_ID(iStartFromCustomer) +
                ...
                m_iCacheOffsetSFFI = m_CustomerAccountTable.GetStartingCA_ID(iStartFromCustomer) +
                                     (iTIdentShift * iMaxAccountsPerCust);
        ...
        */
        TIdent GetSecurityFlatFileIndex(
            ...
            // and avoid the lookup (as we will segfault or get bogus data.)
            TIdent index =
                    (iCustomerAccount - m_iCacheOffsetSFFI) * iMaxSecuritiesPerAccount + iSecurityAccountIndex - 1;
