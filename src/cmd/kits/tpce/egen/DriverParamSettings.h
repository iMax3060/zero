...
******************************************************************************/
    template<typename T>
    class CParametersWithoutDefaults {
    public:
        T cur;
...
******************************************************************************/
    ...
    public:
        ...
        void CheckValid(void) {
            ...
            DRIVERPARAM_CHECK_EQUAL("do_frame* total", cur.do_frame1 + cur.do_frame2 + cur.do_frame3 + cur.do_frame4,
                                    100);
