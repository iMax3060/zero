        ...
        */
        CBrokersTable(CInputFiles inputFiles, TIdent iCustomerCount, TIdent iStartFromCustomer)
                : TableTemplate<BROKER_ROW>(), m_iTotalBrokers(iCustomerCount / iBrokersDiv),
                  ...
                  m_iStartFromCustomer(iStartFromCustomer), m_person(inputFiles, iBrokerNameIDShift, true),
                  m_StatusTypeFile(inputFiles.StatusType), m_pNumTrades(NULL), m_pCommTotal(NULL) {
        };
