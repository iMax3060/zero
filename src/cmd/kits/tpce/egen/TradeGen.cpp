...
CTradeGen::CTradeGen(CInputFiles inputFiles,
        ...
        : m_rnd(RNGSeedTradeGen), m_AddressTable(inputFiles, iCustomerCount, iStartFromCustomer, true,
        ...
        , m_CustomerTable(inputFiles, iCustomerCount, iStartFromCustomer),
          ...
          m_Person(inputFiles, iStartFromCustomer, bCacheEnabled), m_CompanyFile(inputFiles.Company),
          m_SecurityFile(inputFiles.Securities), m_ChargeFile(inputFiles.Charge),
          m_CommissionRateFile(inputFiles.CommissionRate), m_StatusTypeFile(inputFiles.StatusType),
          m_TradeTypeFile(inputFiles.TradeType), m_ExchangeFile(inputFiles.Exchange),
