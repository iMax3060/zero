        ...
        */
        void GenerateDailyMarketRows() {
            ...
            for (i = 0; i < m_iDailyMarketTotalRows; ++i) {
                ...
                //generate prices
                m_row.m_daily_market[i].DM_CLOSE = m_rnd.RndDoubleIncrRange(fDailyMarketCloseMin, fDailyMarketCloseMax,
                                                                            0.01);
    ...
    public:
        ...
        */
        CDailyMarketTable(CInputFiles inputFiles,
                ...
                : TableTemplate<DAILY_MARKET_GEN_ROW>(), m_SecurityFile(inputFiles.Securities),
