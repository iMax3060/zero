    ...
    public:
        CWatchListsAndItemsTable(CInputFiles inputFiles,
                ...
                : TableTemplate<WATCH_LIST_AND_ITEM_ROW>(), m_iRowsToGenForWL(0), m_iRowsGeneratedForWL(0),
                  m_cust(inputFiles, iCustomerCount, iStartFromCustomer), m_iWICount(0), m_iMinSecIdx(iMinSecIdx),
                  m_SecurityFile(inputFiles.Securities), m_bInitNextLoadUnit(false) {
