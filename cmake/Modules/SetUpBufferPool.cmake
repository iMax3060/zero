...
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLOOPMutex")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLOOPMutex!")
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLOOPSpinlock")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLOOPSpinlock!")
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLOOPModulo")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLOOPModulo!")
...
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLOOPThreadLocal")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLOOPThreadLocal!")
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLOOPThreadLocalModulo")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLOOPThreadLocalModulo!")
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerRANDOM")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerRANDOM!")
...
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerCLOCK")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerCLOCK!")
...
ELSEIF(PAGE_EVICTIONER STREQUAL "PageEvictionerLeanStore75")
    MESSAGE(STATUS "INFO: The selected page evictioner is PageEvictionerLeanStore75!")
    IF(NOT POINTER_SWIZZLER STREQUAL "SimpleSwizzling")
        SET(POINTER_SWIZZLER "SimpleSwizzling")
        MESSAGE(NOTICE "The selected page evictioner PageEvictionerLeanStore75 requires the pointer swizzling technique SimpleSwizzling!")
...
ELSE(POINTER_SWIZZLER STREQUAL "NoSwizzling")
    ...
    MESSAGE(NOTICE "The set pointer swizzling technique is unknown. Changed to the default pointer swizzling technique!")
    MESSAGE(STATUS "INFO: The selected pointer swizzling technique is NoSwizzling!")
